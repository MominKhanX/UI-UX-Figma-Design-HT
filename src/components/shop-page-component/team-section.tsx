...
const TeamSection = () => {
  ...
  return (
    <section className="py-16 bg-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 lg:gap-y-28 gap-y-8 gap-8 px-4">
      ...
      <div className="py-16 bg-[#FFFFFF] text-center mt-20">
        ...
        <p className="text-[#737373] font-medium text-[14px] leading-[20px] mt-4 mx-auto">
          Met minim Mollie non deserunt Alamo est sit cliquey dolor <br /> do
          met sent. RELUIT official consequat.
        </p>

        <button className="mt-6 bg-[#23A6F0] rounded-md text-[14px] font-bold text-[#FFFFFF] px-[40px] py-[15px] hover:bg-[#1e6f9e]">
          Try it free now
        </button>
